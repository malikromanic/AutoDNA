...
class Sidebar(QWidget):
    ...
    def _create_ui(self):
        ...
        self.drive_info.setStyleSheet("color: #888888; font-size: 10px; border: none; padding: 2px 0;")
        ...
        nav_label.setStyleSheet("color: #aaaaaa; font-size: 9px; font-weight: bold; letter-spacing: 1px; border: none;")
        ...
        stats_label.setStyleSheet(
            "color: #aaaaaa; font-size: 9px; font-weight: bold; letter-spacing: 1px; border: none;"
        )
        ...
        self.stats_text.setStyleSheet("font-size: 10px; color: #555555; line-height: 1.6; border: none;")
    ...
    def _setup_styles(self):
        self.setStyleSheet("""
            ...
            QPushButton#loadBtn, QPushButton {
